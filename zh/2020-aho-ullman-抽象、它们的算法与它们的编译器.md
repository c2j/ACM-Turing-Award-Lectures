...
![图 1:抽象层次示意图:高层抽象(抽象 1)的操作由低层抽象(抽象 2)实现](assets/2020-aho-ullman/fig-01.png)
...
![图 3:两个关系:Cities (City, State) 和 States (State, Country, Pop)](assets/2020-aho-ullman/fig-03.png)

〔图3:两个关系:Cities (City, State) 和 States (State, Country, Pop)。〕
